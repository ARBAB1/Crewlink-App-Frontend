  ...
  const createGroup = async () => {
    ...
    if (document[0]?.uri !== undefined) {
      ...
      const uploadImage = await fetch(
        `${baseUrl}/messages/upload-message-attachment`,
        {
          method: 'POST',
          headers: {
      ...
      <SafeAreaView style={{flex: 1}}>
        ...
        <ScrollView
          ...
          <View style={styles.ContainerHeader}>
            ...
            <TouchableOpacity
              onPress={route?.params?.isReply ? sendReply : createGroup}
              disabled={ShareText !== '' ? false : true}
              ...
              <View style={styles.TextSide}>
                {route?.params?.isReply && (
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    />
                    <TextC
                      text={route?.params?.Reply_user_name}
                      size={ResponsiveSize(10)}
                      font={'Montserrat-Medium'}
                      style={{
