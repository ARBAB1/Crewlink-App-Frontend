...
const suggestions = [
  {
    id: 1,
    title: 'Restaurants',
    icon: require('../assets/resturant.png'), // Replace with your image
    description: 'Explore a variety of restaurants',
  },
  {
    id: 2,
    title: 'Bars',
    icon: require('../assets/bar.png'), // Replace with your image
    description: 'Find the best bars',
  },
  {
    id: 3,
    title: 'Excursions',
    icon: require('../assets/excursion.png'), // Replace with your image
