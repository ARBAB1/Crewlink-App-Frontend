import {
    ...
    const onSubmit = async data => {
      if (!documentImage == '') {
        try {
          ...
          formData.append('suggestion_title', data?.title);
      
          formData.append('suggestion_details', data?.description);
        ...
        <SafeAreaView style={styles.container}>
          ...
          <ScrollView
            ...
            <View
              ...
              <TextC text={'Title'} font={'Montserrat-Bold'} />
            ...
            <View style={{paddingTop: ResponsiveSize(12)}}>
              <View
                ...
                <TextC text={'Description'} font={'Montserrat-Bold'} />
            ...
            <View
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <TextC text={'Image'} font={'Montserrat-Bold'} />
                {documentImage == '' && (
                  <TextC
                    text={'*'}
                    font={'Montserrat-Bold'}
  ...
  export default connect(mapStateToProps, AllEventAction)(AddSuggestion);
