                ...
                {items?.item?.is_media == 'Y' ? (
                  <>
                    <Pressable
                      ...
                      {lastElement?.message_id == items?.item?.message_id &&
                      items?.item?.read_status == 'Y' ? (
                        <View
                          style={{
                            flexDirection: 'row',
                            justifyContent: 'flex-end',
      ...
      <SafeAreaView style={{flex: 1, backgroundColor: global.white}}>
        ...
        <ScrollView
          ...
          contentContainerStyle={{
            ...
            paddingBottom: ResponsiveSize(ReplyMessage?.message_id ? 180 : 65),
          }}>
          {hasMoreContent && (
            <>
              {!loader && (
            ...
            <Animated.View style={{...styles.ReplyBox, opacity: fadeAnim}}>
              <View style={styles.ReplyInfo}>
                {ReplyMessage?.senderUserId == user_id ? (
                  ...
                  <TextC
                    text={`Replying to ${route?.params?.user_name}`}
                    font={'Montserrat-Medium'}
                    size={ResponsiveSize(10)}
                    style={{
                      color: global.description,
